...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //JPA 기능까지 한번에 테스트할시
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles = "USER") //인증된 모의(가짜) 사용자를 만들어서 사용, roles에 권한을 추가, 이 어노테이션으로 인해 ROLE_USER 권한을 가진 사용자가 API를 요청하는 것과 동일한 효과를 가지게 됨.
